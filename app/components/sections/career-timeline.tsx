...
export default function CareerTimeline() {
  return (
    <Reveal><section id="pengalaman" className="bg-white py-20 px-6 border-b-2 border-black">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">Pengalaman</h2>
        <p className="text-center text-gray-600 text-lg mb-12 max-w-xl mx-auto">
          Perjalanan karir sebagai backend engineer.
        </p>
        <div className="max-w-4xl mx-auto relative">
          <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-dark/20" />
          {EXPERIENCE.map((exp, i) => (
            <div key={i} className="relative pl-20 pb-12 last:pb-0">
              <div className="absolute left-4 top-1 w-9 h-9 rounded-full bg-primary border-2 border-dark flex items-center justify-center text-sm font-bold z-10">
                {i + 1}
              </div>
